...
二、运行方法
要求 Python 3.11+、Git 和兼容 tool calling 的 API。
...
四、参考与边界
参考 GenericAgent、CodePlan 与 VRpilot。Runtime 只验证证据和版本，不证明需求正确，也不提供恶意代码沙箱。
